...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_list:
        ...
        if (countyvotes > winningcounty_count) and (countyvote_percentage > winningcounty_percentage):
            winningcounty_count = countyvotes
            winning_county = county_name
            winningcounty_percentage = countyvote_percentage
